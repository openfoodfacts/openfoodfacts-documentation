---
title: "Thoughts on Scoring"
description: "Explore different methods for scoring search results in Search-a-licious. This document covers using scripts, K-Nearest Neighbors (KNN), and their application to personal search at Open Food Facts, analyzing the pros and cons of each approach."
---
...
then use dotProduct. ( a1 _ b1 + a2 _ b2 + a3 \* b3)
...
score is 0.5 + (dot_product(query, vector) / (32768 _ dims)), so to retrieve the dot product you should do
(score - 0.5) _ 32768 \* dims
