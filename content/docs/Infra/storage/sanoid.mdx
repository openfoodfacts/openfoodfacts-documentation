...
<Tabs>
  <Tab value="synced" label="Synced Datasets">
  ...
  <Tab value="local" label="Local Datasets">
...
<Tabs>
  <Tab value="services" label="Service Status">
  ...
  <Tab value="snapshots" label="Snapshot Status">
    ### List Snapshots
