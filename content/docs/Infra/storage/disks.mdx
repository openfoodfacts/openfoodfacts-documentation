...
Separate primary data, cache data, configuration data, and system data for easier management
</Card>
...
<Cards>
<Card title="ZFS Overview" href="./zfs-overview.md">
We extensively use ZFS for advanced storage management and data protection
</Card>
<Card title="Disk Space Management" href="./how-to-add-disk-space-on-qemu.md">
...
<Cards>
<Card title="Smartctl Guide (French)" href="https://www.malekal.com/smartctl-verifier-son-disque-en-ligne-de-commandes-linux/">
Comprehensive guide on using smartctl for disk verification
</Card>
<Card title="Unreadable Sectors" href="https://www.truenas.com/community/threads/is-this-a-bad-sign-smartd-1-currently-unreadable-pending-sectors.9824/#post-42966">
