...
<Tabs items={["misc", "concepts", "admin", "performance"]}>
<Tab value="misc">
...
<Tab value="concepts">
  [Basic
  Concepts](https://openzfs.github.io/openzfs-docs/Basic%20Concepts/index.html)
  is a good place to return to from time to time to grab concepts better
</Tab>

<Tab value="admin">
  [Man pages on system administration
  commands](https://openzfs.github.io/openzfs-docs/man/master/8/index.html) are
  really useful
</Tab>
...
<Cards>
  <Card title="Pool Status">`zpool status` - See eventual errors</Card>
  <Card title="Device List">`zpool list -v` - See all devices</Card>
