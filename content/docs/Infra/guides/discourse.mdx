...
<Step>
  **Add Plugin Repository** 
  Add [the plugin's repository URL](https://github.com/paviliondev/discourse-events.git) to your container's
  app.yml file, right after the `git clone https://github.com/discourse/docker_manager.git`
</Step>
