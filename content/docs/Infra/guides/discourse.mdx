...
The sender email [have to be on main domain](./mail.md#only-domain), NOT forum.openfoodfacts.org.
</Callout>
...
<Card title="Mail Gateway" href="./mail.md">
...
Try to upgrade through the web interface: https://forum.openfoodfacts.org/admin/upgrade (you need to be an admin)
</Step>

<Step>
**Test the Update**
Test the update during several days to ensure stability.
</Step>
...
apt update && apt dist-upgrade # updates the whole system
```
</Step>
...
```bash title="Clean Up"
cd /var/discourse
./launcher cleanup # cleans old docker images
apt-get autoclean
apt-get autoremove
```
</Step>
...
<Step>
**Create Snapshot**
Create a snapshot if haven't done it yet!
</Step>
...
<Step>
**Install Theme in Discourse**
- Go to administration / Customize / theme
- Install / from a git repository: https://github.com/paviliondev/discourse-matomo-analytics.git
</Step>
