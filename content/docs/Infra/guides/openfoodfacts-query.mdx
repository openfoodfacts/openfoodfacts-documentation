...
<Tabs items={["Production Specs", "Staging Specs", "Performance"]}>
  <Tab value="Production Specs">
    - **Server:** off1 Proxmox host - **Container:** CT 115 (dedicated) -
    **Deployment:** Docker Compose - **URL:** https://query.openfoodfacts.org/
  </Tab>

  <Tab value="Staging Specs">
    - **Server:** Staging dockers VM - **Storage:** ZFS dataset on NVME pool -
    **URL:** https://query.openfoodfacts.net/
  </Tab>

  <Tab value="Performance">
    - **Database:** Bypasses MongoDB for aggregations - **Speed:** Faster than
    direct database queries - **Scalability:** Optimized for high-volume product
    exploration
  </Tab>
</Tabs>
