---
title: "Off1 Upgrade"
description: "This report details the comprehensive upgrade of off1, including physical hardware changes, BIOS configuration, firmware updates, network setup, and ZFS pool creation. It also covers PVE cluster integration and data snapshot/synchronization setup."
author: "Unknown Author"
mail: ""
date: "2023-12-08"
---

This is the same operation as [# 2023-02-17 Off2 Upgrade](/docs/Infra/reports/2023/2023-02-17-off2-upgrade)
but for off1.
...
For more details, see also [Hardware in 2023-02-17 Off2 Upgrade](/docs/Infra/reports/2023/2023-02-17-off2-upgrade#hardware)
...
Namespace 1 Size/Capacity:          14
403
239
936 [14,4 GB]
/dev/nvme2 --------
Model Number:                       Samsung SSD 970 EVO Plus 1TB
Namespace 1 Size/Capacity:          1
000
204
886
016 [1,00 TB]
...
I then go to `permissions` and give the PVEAuditor role to the group on `/` with _propagate_.
...
Simply following [our Munin doc on how to configure a server](/docs/Infra/monitoring/munin#how-to-configure-a-server)

## Configuring snapshots and syncoid

I first installed sanoid following [install instructions](/docs/Infra/storage/sanoid#how-to-build-and-install-sanoid-deb)
