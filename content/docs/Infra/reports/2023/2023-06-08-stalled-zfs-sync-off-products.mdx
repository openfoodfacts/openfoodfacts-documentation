---
title: Stalled ZFS Sync Resolution
description: This report details the resolution of a stalled ZFS sync for off products on OVH3, caused by an outdated snapshot cleanup policy. It covers troubleshooting steps, including rolling back to an older snapshot, manually relaunching sync, and adjusting retention policies to prevent future issues.
