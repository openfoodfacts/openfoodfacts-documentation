...
description: "This report details the incident of an expired SSL certificate for images.openfoodfacts.org on off2, including the investigation, temporary solution, and relevant file system details. It covers the steps taken to resolve the issue."
