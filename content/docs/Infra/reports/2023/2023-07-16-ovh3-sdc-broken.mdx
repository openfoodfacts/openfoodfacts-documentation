---
title: "OVH3 Disk Failure"
description: "This report details a disk failure on OVH3, covering the OVH intervention, the process of replacing the faulty disk in the ZFS pool, and temporarily serving images from off2 to mitigate impact during resilvering."
