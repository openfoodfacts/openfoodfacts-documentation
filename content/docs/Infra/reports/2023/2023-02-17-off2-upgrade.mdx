---
title: Off2 Upgrade Report
description: This report details the comprehensive upgrade of Off2, covering hardware installations, BIOS configurations, and Proxmox setup. It includes ZFS pool creation, troubleshooting initial boot issues, and post-installation steps for optimal server performance.
...
![SDD adpater card](../../img/2023-02-free-dc-ssd-pci-card.jpg "The SDD adapter card")

![Inserting adpater card](../../img/2023-02-free-dc-ssd-pci-card-insertion.jpg "Inserting SDD adapter card into the extension slot")

![Insert back slot in server](../../img/2023-02-free-dc-ssd-pci-setup.jpg "Inserting the extension slot with the SDD adapter card back in the server")
...
![BIOS screen - slot bifurcation menu](../../img/2023-02-free-dc-bios-slot-bifurcation-menu.jpg "Getting to Slot bifurcation menu in BIOS")

![BIOS screen - slot bifurcation](../../img/2023-02-free-dc-bios-slot-bifurcation-auto.jpg "Slot bifurcation set to Auto Discovery in BIOS")
...
![BIOS screen - IDRAC](../../img/2023-02-free-dc-bios-idrac-settings.jpg "IDRAC settings in BIOS")
...
![BIOS screen - PERC - 1](../../img/2023-02-free-dc-bios-disks-perc-1.jpg "PERC settings in BIOS - first screen")


![BIOS screen - PERC - 2](../../img/2023-02-free-dc-bios-disks-perc-2.jpg "PERC settings in BIOS - second screen")


![BIOS screen - PERC - hba](../../img/2023-02-free-dc-bios-disks-perc-hba.jpg "PERC settings in BIOS - HBA mode screen")

## Proxmox install

We plug the bootable USB stick with [Proxmox VE](https://www.proxmox.com/en/proxmox-ve) iso for installation.

![USB stick plugged for install](../../img/2023-02-free-dc-usb-stick.jpg "The USB stick with iso of Proxmox VE ready to boot")
...
![Proxmox VE first screen](../../img/2023-02-free-dc-pve-install-start.jpg "The first screen of install of Proxmox VE")

![Proxmox VE choosing ZFS](../../img/2023-02-free-dc-pve-install-choice-zfs.jpg "We choose to install on ZFS")

![ZFS pool choice screen](../../img/2023-02-free-dc-pve-install-zfs-pool.jpg "We choose the disks to add in the ZFS pool")

![ZFS advanced](../../img/2023-02-free-dc-pve-install-zfs-pool-advanced.jpg "We kept default for ZFS advanced options")
...
![eno2 config](../../img/2023-02-free-dc-pve-install-network.jpg "Configuration for eno2 interface")

We are asked for confirmation:

![Install summary screen](../../img/2023-02-free-dc-pve-install-summary.jpg "Summary of Proxmox install")
...
![import of rpool with numeric id](../../img/2023-02-free-dc-pve-setup-zpool-import-rpool.jpg "We had to use numeric id to import rpool because of name clash")
...
![import of rpool2 with numeric id](../../img/2023-02-free-dc-pve-setup-zpool-import-rpool2.jpg "We had to use numeric id to import rpool2 because of name clash")
...
![final zfs pools](../../img/2023-02-free-dc-pve-setup-zpool-import-off-zfs.jpg "Final ZFS pools")
