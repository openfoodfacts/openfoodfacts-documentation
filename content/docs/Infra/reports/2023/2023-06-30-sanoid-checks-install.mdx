---
title: Sanoid Checks Install
description: This report details the installation and configuration of Sanoid checks to monitor its proper functioning. It covers creating and testing the `sanoid_check.sh` script, setting up systemd units and timers, and configuring email alerts for Sanoid and Syncoid failures to ensure reliable operation.
