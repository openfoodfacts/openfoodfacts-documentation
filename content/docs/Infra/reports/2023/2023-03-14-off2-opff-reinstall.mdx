---
title: OFF2 Reinstall Migration
description: This report details the reinstallation and migration of OFF2, covering storage, NGINX and Apache setup, data handling with ZFS, CPAN installation, service configuration, and debugging. It also outlines procedures for switching to the new setup and lists remaining tasks for a complete and functional system.
...
I followed [How to create a new Container](/docs/Infra/virtualization/proxmox#how-to-create-a-new-container)
...
**Important**: I removed the gateway on net0 (see [here](/docs/Infra/services/nginx-reverse-proxy#network-specific-interface)).
...
I created a CT followings [How to create a new Container](/docs/Infra/virtualization/proxmox#how-to-create-a-new-container) it went all smooth.
...
We follow [Steps to create Nginx configuration](/docs/Infra/services/nginx-reverse-proxy#steps-to-create-nginx-configuration)
