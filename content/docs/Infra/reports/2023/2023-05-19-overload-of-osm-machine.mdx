---
title: Overload of OSM Machine
description: This report details a MongoDB outage on 2023-05-18, caused by an overloaded Open Street Map virtual machine. It covers the symptoms, investigation, resolution steps taken by the team, and mitigation strategies implemented to prevent future occurrences.
