---
title: "OVH3 Disk Errors"
description: "This post-mortem details the 2023-11-28 incident of disk errors on OVH3, specifically with /dev/sdf, causing NGINX to block. It covers the analysis of smartctl logs, the repair process including disk replacement, and the challenges encountered during resilvering."
...
We already had a disk replaced 4 months before, see [Post-mortem 2023-07-16 Disk sdc errors on OVH3](/docs/Infra/reports/2023/2023-07-16-ovh3-sdc-broken)
...
- staging Open Food Facts (.net) won't work (it use NFS mount of products and images ZFS datasets)
  and of course replications and and backups of ovh1 and ovh2 were not happening.
