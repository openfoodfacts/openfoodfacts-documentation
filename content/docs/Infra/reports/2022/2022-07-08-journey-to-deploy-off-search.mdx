---
title: "Deploying OFF-Search"
description: "This report details the deployment of openfoodfacts-search to a staging environment, covering Docker preparation, image creation, and deployment processes. It includes securing Elasticvue access, handling secrets, and troubleshooting initial connection issues and live update configurations for optimal performance."
author: "Alex Garel"
