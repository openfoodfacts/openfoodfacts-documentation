---
title: "Kibana Down Troubleshooting"
description: "This report details the troubleshooting process for a Kibana outage caused by an Elasticsearch circuit breaking exception. It covers symptoms, diagnosis, memory tuning, snapshotting, index removal, and fixing snapshot and ILM policies to prevent future occurrences."
author: "Alex Garel"
