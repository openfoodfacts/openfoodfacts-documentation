---
title: "Zammad Elasticsearch Not Running"
description: "This report details troubleshooting Elasticsearch not running on Zammad, caused by an OutOfMemoryError due to incorrect memory allocation in an LXC container. It covers the solution of manually setting heap size and re-indexing the search index."
author: "Alex Garel"
