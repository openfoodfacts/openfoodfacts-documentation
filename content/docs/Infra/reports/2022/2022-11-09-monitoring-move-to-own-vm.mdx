---
title: "Monitoring VM Migration"
description: "This report details the migration of monitoring services to a dedicated VM on OVH1. It covers assessing disk space, memory, and CPU usage, creating the VM, installing the OS, and setting up Docker and ZFS shares. It also outlines the process of migrating data for Elasticsearch, InfluxDB, Prometheus, and Grafana."
author: "Alex Garel"
