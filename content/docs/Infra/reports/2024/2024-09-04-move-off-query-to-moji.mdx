...
see [2024-09-05 adding ipv6 to off2](/docs/Infra/reports/2024/2024-09-05-adding-ipv6-to-off2.mdx)
...
And did usual configurations, and cloned the [off-infrastructure repository](/docs/Infra/how/how-to-have-server-config-in-git.mdx)
