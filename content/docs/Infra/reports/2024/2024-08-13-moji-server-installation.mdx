---
title: "Moji Server Installation"
description: "This report details the installation and configuration of the new Moji server, including Proxmox setup, VM creation for Docker, IPv6 configuration, and the decision to use Stunnel for secure communication between OVH and Moji servers."
