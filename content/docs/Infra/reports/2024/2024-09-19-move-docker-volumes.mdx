---
title: "Move Docker Volumes"
description: "This report details the process of moving Docker volumes from the system disk to dedicated locations on docker-staging and docker-prod VMs. It outlines the steps for copying data, modifying the Makefile, recreating volumes, and verifying disk space to optimize storage and prevent alerts."
