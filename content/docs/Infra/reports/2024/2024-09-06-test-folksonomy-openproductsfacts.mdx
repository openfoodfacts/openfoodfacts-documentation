---
title: "Folksonomy Testing"
description: "This report details testing folksonomy functionality for Open Products Facts, addressing authentication issues due to cookie sharing and domain differences. It covers Folksonomy API changes, DNS configurations, and Nginx proxy settings to enable proper authentication and cross-domain functionality."
