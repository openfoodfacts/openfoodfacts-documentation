---
title: "Certbot Failure Report"
description: "This report details a Certbot failure on the off2 reverse proxy due to stalled ACME challenge records in OVH DNS. It covers the alert, analysis, resolution steps including cleaning DNS zones, and post-operations such as adding an email alert for future Certbot service failures."
