...
I created a CT on off2 followings [How to create a new Container](/docs/Infra/virtualization/proxmox#how-to-create-a-new-container):
...
I also [configure postfix](/docs/Infra/services/mail#postfix-configuration) and [tested it](/docs/Infra/services/mail#testing-that-the-gateway-is-well-configured).

Cloned this repository in [/opt using a root key as deploy key](/docs/Infra/how/how-to-have-server-config-in-git)
