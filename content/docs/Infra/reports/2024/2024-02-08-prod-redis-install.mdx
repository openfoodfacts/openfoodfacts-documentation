---
title: "Production Redis Install"
description: "This report details the installation and configuration of Redis on a new CT (off-redis) on off2. It covers setting up the CT, installing Redis, configuring stunnel for secure access from OVH, and enabling email notifications for service failures to ensure robust monitoring."
...
I created a CT on off2 followings [How to create a new Container](/docs/Infra/virtualization/proxmox.mdx#how-to-create-a-new-container):
* id 122 (off-redis)
...
I also [configure postfix](/docs/Infra/services/mail.mdx#postfix-configuration) and [tested it](/docs/Infra/services/mail.mdx#testing-that-the-gateway-is-well-configured).

Cloned this repository in [/opt using a root key as deploy key](/docs/Infra/how/how-to-have-server-config-in-git.mdx)
