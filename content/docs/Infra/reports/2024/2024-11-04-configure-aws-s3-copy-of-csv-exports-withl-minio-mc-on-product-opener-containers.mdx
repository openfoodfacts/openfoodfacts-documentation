---
title: "Configure AWS S3 Copy"
description: "This report details the configuration of AWS S3 copy for CSV and RDF exports from OFF, OBF, OPF, and OPFF. It covers installing MinIO mc, copying AWS and MinIO configurations, and verifying mc functionality to create S3 buckets."
