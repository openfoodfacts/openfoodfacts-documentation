---
title: "Postfix Exporter on PMG"
description: "This report details the installation and configuration of a Postfix exporter on the Proxmox Mail Gateway (PMG) container. It covers testing the exporter, adding scraping configuration to Prometheus, and setting up an alert for high mail queue messages."
