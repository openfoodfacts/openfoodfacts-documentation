---
title: "Moji Post-Installation & Backup Sync"
description: "This report details the post-installation configuration of the Moji server, focusing on setting up NFS shares for Robotoff DB backups and configuring Sanoid and Syncoid for automated snapshots and synchronization. It outlines the steps for NFS server installation, ZFS dataset sharing, and secure snapshot pulling to OVH3."
