---
title: "Network Down Postmortem"
description: "This postmortem analyzes the openfoodfacts.net outage on 2021-10-03, attributing it to a Docker storage driver change. It details the impact on Proxmox containers, the short-term resolution of reverting the driver, and long-term plans for stability, including action items and lessons learned from the incident."
