---
title: "Matomo Installation Log"
description: "This document logs the installation process of Matomo, including Nginx and SSL configuration, PHP setup, MariaDB integration, and activating reverse proxy mode. It also details setting up offline archival and performance tweaks."
...
- ensure [mail is setup correctly on the server](/docs/Infra/services/mail#servers)
