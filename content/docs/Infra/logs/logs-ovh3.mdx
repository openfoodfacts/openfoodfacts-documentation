...
<Tabs items={["2023-09-07", "2023-06-08", "2023-05-30", "2023-05-04"]}>
  <Tab value="2023-09-07">
    ### 2023-09-07 ZFS Dataset Stalled **Context:** Day after switching
    images.openfoodfacts.org back to ovh3. **Symptoms:** -
    Images.openfoodfacts.org down alert - Nginx restart failed with zombie
    processes - Processes couldn't be killed (I/O wait state) - File listing
    worked, but content access hung - ZFS pool status showed READ error on sdb
    **Resolution:** Hard reboot required. [Slack
    Discussion](https://openfoodfacts.slack.com/archives/C01F18SQ8F7/p1694089024775499)
  </Tab>

  <Tab value="2023-06-08">
    ### 2023-06-08 ZFS Dataset Stalled **Symptoms:** - Nginx images not
    responding - off.net also affected - ZFS dataset stopped working at 00:50
    UTC **Resolution:** Hard reboot (no symptoms in logs). [Slack
    Discussion](https://openfoodfacts.slack.com/archives/C1FPYCWM7/p1686298752505019)
  </Tab>
