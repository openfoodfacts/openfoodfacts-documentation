...
<Tabs>
  <Tab value="mongodb" label="MongoDB Issues">
    ### Common MongoDB Problems - **Connection Limits**: Exceeded maximum
    connections (301 limit) - **Service Unresponsiveness**: Complete service
    failures - **Resource Exhaustion**: System overload affecting database
    performance - **Network Connectivity**: Inter-server communication issues
  </Tab>

  <Tab value="network" label="Network Issues">
    ### Network Connectivity Problems - **Routing Issues**: Missing routes after
    reboots - **Inter-server Communication**: OPFF to MongoDB connectivity -
    **Configuration Persistence**: Routes not surviving reboots
  </Tab>

  <Tab value="system" label="System Issues">
    ### System-Level Problems - **Resource Overload**: CPU, memory, or I/O
    exhaustion - **Service Dependencies**: Cascading failures - **Configuration
    Loss**: Settings not persisting after restarts
  </Tab>
</Tabs>
