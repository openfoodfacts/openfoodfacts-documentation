...
# Odoo: Our Relationship Management
...
<Cards>
  <Card title="Access Control" href="#guidelines">
    Separate technical and functional admin rights
  </Card>
  <Card title="Planning Required" href="#guidelines">
    Clear usage requirements and discussion before module installation
  </Card>
  <Card title="Testing First" href="#guidelines">
...
<Tabs>
  <Tab value="basic" label="Basic Commands">
