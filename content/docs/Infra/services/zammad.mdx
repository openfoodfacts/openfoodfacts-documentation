...
<Card title="Current Hosting Details" description="Temporary infrastructure setup requiring migration">
...
<Card title="Package-Based Installation" description="Standard Zammad package deployment">
...
<Card title="Multi-Service Architecture" description="Distributed service components for scalability">
...
<Card title="Search Engine Configuration" description="Elasticsearch setup for advanced search capabilities">
...
<Card title="Infrastructure Migration Planning" description="Moving Zammad to main infrastructure">
