...
<Cards>
  ...
  <Card title="Relay Configuration">
    Relay is set to smtp-relay.gmail.com (for incoming mails - though we
    shouldn't need it)
  </Card>
  <Card title="Port Configuration">
    - SMTP private port: `25` - Public port: `26`
  </Card>
...
<Step>**Check PMG VM Logs** - `/var/log/mail*` on pmg VM</Step>
