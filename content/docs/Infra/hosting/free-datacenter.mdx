...
<Step>
  **Switching On** The server switch on button is on the front panel, a small ⏼
  button on the right.
</Step>
...
<Callout type="info">
  **Network Details:** - Gateway: 213.36.253.222 - DNS: 213.36.253.10
  (gw4-vl12.free.org) - Reverse names: - off1.openfoodfacts.org for
  213.36.253.206 - off2.openfoodfacts.org for 213.36.253.208
</Callout>
...
<Card title="off2.openfoodfacts.org">
  **Hardware Specifications:** - 4x14TB disks - 2x2TB SSD - 1x1TB SSD - 1x60GB
  [optane disk](https://en.wikipedia.org/wiki/3D_XPoint)
</Card>
...
<Callout type="info">
  We also have 213.36.253.214 which is dedicated to the [NGINX reverse
  proxy](/docs/Infra/networking/nginx-reverse-proxy).
</Callout>
