...
<Cards>
  <Card href="tutorial-off-api.mdx" title="API Tutorial" description="New to API usage? Start with our comprehensive tutorial" />
  <Card href="ref-v2.mdx" title="API Reference" description="Complete API reference documentation" />
</Cards>
...
**Important**: You just have to prefix `add_` before the name of the field to append values instead of replacing them.
</Callout>
...
<Cards>
  <Card href="https://wiki.openfoodfacts.org/API/Read/Search" title="v1 Search API" description="Documentation for v1 Search API with full text search" external />
  <Card href="https://openfoodfacts.github.io/openfoodfacts-server/api/ref-v2/#get-/api/v2/search" title="v2 Search API" description="Reference documentation for v2 search API" external />
  <Card href="https://search.openfoodfacts.org/docs" title="Search-a-licious API" description="The future of search in Open Food Facts (beta)" external />
</Cards>
...
<Card href="https://search.openfoodfacts.org/docs" title="Search-a-licious API Documentation" description="Access comprehensive suggestion API with all used values" external />
...
<Card href="https://openfoodfacts.github.io/openfoodfacts-server/api/ref-v3/#get-/api/v3/taxonomy_suggestions" title="v3 API Reference Documentation" description="Complete documentation for taxonomy suggestions endpoint" external />
