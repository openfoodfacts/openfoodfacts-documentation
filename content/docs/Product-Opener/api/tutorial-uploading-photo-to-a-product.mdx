...
Be sure to also read the [introduction to the API](./index.mdx)
...
For more details, visit the : [Authentication paragraph in our introduction](../index.mdx#authentication).
