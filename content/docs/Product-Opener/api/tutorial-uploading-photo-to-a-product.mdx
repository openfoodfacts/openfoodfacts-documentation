---
title: "Tutorial on uploading images to the Open Food Facts API"
---
...
```text title="Describing the Post Request"
...
```bash title="Upload Photo of a Product"
...
```json title="Upload Photo of a Product"
{
  "files": [
    {
