...
<Steps>
<Step>
**Implement the complete flow** so users get immediate results with minimal effort on their side
</Step>
<Step>
**Ensure user satisfaction** by handling all possible data states
</Step>
<Step>
**Follow the technical guide** in the [product addition tutorial](../tutorials/adding-missing-products.mdx) for required operations
</Step>
</Steps>
...
`nutriscore-e-new-en.svg` → `nutriscore-e-new-fr.svg`
</Tab>
</Tabs>
