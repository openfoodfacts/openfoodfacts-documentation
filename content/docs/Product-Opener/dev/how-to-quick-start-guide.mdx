...
<Card title="Alternative: Cloud Development" href="how-to-use-gitpod.mdx">
Follow the Gitpod how-to guide to instantly provision a ready-to-code development environment in the cloud.
</Card>
...
Check [how to learn perl](how-to-learn-perl.mdx)!
</Callout>
...
<Card title="Docker CE" href="https://docs.docker.com/engine/install/" description="Container platform" />
</Cards>
...
<Cards>
<Card title="Make for Windows" href="http://gnuwin32.sourceforge.net/packages/make.htm" description="Build automation tool" />
<Card title="wget for Windows" href="https://eternallybored.org/misc/wget/" description="For downloading the full product database" />
</Cards>
...
* For a full description of available make targets, see [Docker / Makefile commands](ref-docker-commands.mdx)
...
To learn more about developing with Docker, see the [Docker developer's guide](how-to-develop-using-docker.mdx).

To have all site pages on your dev instance, see [Using pages from openfoodfacts-web](how-to-use-pages-from-openfoodfacts-web.mdx)

[Using Repl](how-to-use-repl.mdx) offers you a way to play with perl.

Specific notes are provided on [applying AGRIBALYSE updates to support the Ecoscore](how-to-update-agribalyse-ecoscore.mdx) calculation.
