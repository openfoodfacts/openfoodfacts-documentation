---
title: "How to debug Minion import and export tasks"
---
...
```bash title="Checking the status of Minion tasks (jobs)"
...
```bash title="Debugging failed import of pro platform data on public platform"
