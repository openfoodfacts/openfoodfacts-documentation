---
title: "Agribalyse Updates"
description: "Comprehensive guide for updating the AGRIBALYSE database to calculate Ecoscore values including data conversion, category review, and impact analysis."
---
...
<Steps>
<Step title="Download and Save Spreadsheet">
...
<Step title="Verify Ecoscore Data">
...
<Step title="Build Taxonomies and Update Tests">
...
<Step title="Check Product Database Impact">
...
```javascript title="Unset Previous Eco-Score Data"
...
### Fetch Specific Changed Products
...
<Step title="Re-run update_all_products">
...
<Steps>
<Step title="Review and Add Categories">
...
<Step title="Consider Representative Codes">
