---
title: "How to update Agribalyse (Ecoscore)"
---
...
```js title="Review and fix any changed Categories"
...
```bash title="Review and fix any changed Categories"
...
```js title="Add new Categories for new AGRIBALYSE codes"
