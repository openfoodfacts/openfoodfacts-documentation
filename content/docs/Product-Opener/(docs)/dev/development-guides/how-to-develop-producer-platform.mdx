...
Docker should already be [set up for development](how-to-quick-start-guide).
...
<Steps>
  <Step title="Stop Frontend Service (Pro Shell)">
    In your *pro shell*, run: ```bash title="Stop Frontend Service" docker
    compose stop frontend ```
  </Step>
  <Step title="Start Frontend Service (Non-Pro Shell)">
    In your *non pro shell*, run: ```bash title="Start Frontend Service" docker
    compose up frontend ```
  </Step>
</Steps>
