...
<Card title="Alternative: Cloud Development" href="how-to-use-gitpod">
...
Check [how to learn perl](how-to-learn-perl)!
...
- For a full description of available make targets, see [Docker / Makefile commands](ref-docker-commands)
...
To learn more about developing with Docker, see the [Docker developer's guide](how-to-develop-using-docker).

To have all site pages on your dev instance, see [Using pages from openfoodfacts-web](how-to-use-pages-from-openfoodfacts-web)

[Using Repl](how-to-use-repl) offers you a way to play with perl.

Specific notes are provided on [applying AGRIBALYSE updates to support the Ecoscore](how-to-update-agribalyse-ecoscore) calculation.
