...
<Callout type="info" title="New to Perl?">
  Check out our guide on [how to learn Perl](./how-to-learn-perl)!
</Callout>
...
<Steps>
  <Step title="Add CPANMOPTS to .env or .envrc">
    Try going in your .env (or [.envrc](./how-to-use-direnv)) file and add the
    line: ``` CPANMOPTS=--with-develop --with-feature=off_server_dev_tools ```
  </Step>
