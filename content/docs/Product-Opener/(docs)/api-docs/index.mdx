...
<Cards>
  <Card
    href="/docs/Product-Opener/api-docs/getting-started/"
    title="Getting Started"
    description="API introduction, tutorials, and basic usage guides"
  />
  <Card
    href="/docs/Product-Opener/api-docs/advanced-features/"
    title="Advanced Features"
    description="Knowledge panels, Wikidata integration, and advanced API functionality"
  />
  <Card
    href="/docs/Product-Opener/api-docs/data-access/"
    title="Data Access"
    description="Images, datasets, and bulk data operations"
  />
  <Card
    href="/docs/Product-Opener/api-docs/reference/"
    title="Reference"
    description="Cheatsheets, schemas, changelogs, and technical references"
  />
  <Card
    href="/docs/Product-Opener/api-docs/meta-documentation/"
    title="Meta Documentation"
    description="TODOs, development notes, and documentation improvement plans"
  />
</Cards>
...
<Steps>
  <Step>
    **Start with Basics**: Read the [Getting Started](/docs/Product-Opener/api-docs/getting-started/)
    tutorials
  </Step>
  <Step>
    **Explore Features**: Learn about [Advanced Features](/docs/Product-Opener/api-docs/advanced-features/)
    like Knowledge Panels
  </Step>
  <Step>
    **Access Data**: Use [Data Access](/docs/Product-Opener/api-docs/data-access/) guides for images and bulk
    operations
  </Step>
  <Step>
    **Reference**: Check [Reference](/docs/Product-Opener/api-docs/reference/) materials for quick lookups
  </Step>
</Steps>
