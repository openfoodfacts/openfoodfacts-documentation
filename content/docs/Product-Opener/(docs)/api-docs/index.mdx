...
If you need to fetch a significant fraction of the database, we recommend [downloading the data as a CSV or JSONL file directly](https://world.openfoodfacts.org/data). If you need to download images in bulk, we [have a guide for that](./how-to-download-images.mdx).
...
- [OpenAPI documentation (v2)](../api/ref-v2.mdx)
- [OpenAPI documentation for v3](../api/ref-v3.mdx) (under active development, may change frequently)
- A [cheatsheet](../api/ref-cheatsheet.mdx) listing some common patterns.
- A [change log for the API and product schema](../api/ref-api-and-product-schema-change-log.mdx)

## Tutorials

- A comprehensive introduction to [Using the Open Food Facts API](tutorial-off-api.mdx).
- [Uploading images to the Open Food Facts API](tutorial-uploading-photo-to-a-product.mdx)
...
<Cards>
  <Card href="getting-started/" title="Getting Started" description="API introduction, tutorials, and basic usage guides" />
  <Card href="advanced-features/" title="Advanced Features" description="Knowledge panels, Wikidata integration, and advanced API functionality" />
  <Card href="data-access/" title="Data Access" description="Images, datasets, and bulk data operations" />
  <Card href="reference/" title="Reference" description="Cheatsheets, schemas, changelogs, and technical references" />
  <Card href="meta-documentation/" title="Meta Documentation" description="TODOs, development notes, and documentation improvement plans" />
</Cards>
...
<Steps>
<Step>
**Start with Basics**: Read the [Getting Started](getting-started/) tutorials
</Step>
<Step>
**Explore Features**: Learn about [Advanced Features](advanced-features/) like Knowledge Panels
</Step>
<Step>
**Access Data**: Use [Data Access](data-access/) guides for images and bulk operations
</Step>
<Step>
**Reference**: Check [Reference](reference/) materials for quick lookups
</Step>
</Steps>
