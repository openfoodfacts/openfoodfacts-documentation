...
<Steps>
  <Step>
    **Start with Basics**: Read the [Getting Started](getting-started/)
    tutorials
  </Step>
  <Step>
    **Explore Features**: Learn about [Advanced Features](advanced-features/)
    like Knowledge Panels
  </Step>
  <Step>
    **Access Data**: Use [Data Access](data-access/) guides for images and bulk
    operations
  </Step>
  <Step>
