...
<Card href="/docs/Product-Opener/api-docs/advanced-features/ref/schemas/knowledge_panels/panels.yaml" title="Knowledge Panels JSON Schema" description="Complete structure of the knowledge panels data returned by the API" />
