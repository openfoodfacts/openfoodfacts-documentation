...
```json title="1. Fiber Warning Message" msgctxt
...
```json title="2. Fruits/Vegetables/Nuts Warning" msgctxt
...
```json title="3. Ingredients Estimate Warning" msgctxt
...
```json title="4. Category Estimate Warning" msgctxt
