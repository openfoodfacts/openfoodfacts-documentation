---
title: "🎯 Tutorial: Personalizing Product Matching with Open Food Facts Attributes API"
---
...
```http title="✅ STEP 1 — Retrieve the attribute taxonomy"
GET https://world.openfoodfacts.org/api/v2/attribute_groups
```

#### Response Sample:

```json title="✅ STEP 1 — Retrieve the attribute taxonomy"
{
  "attribute_groups": [
    {
      "id": "nutriscore",
...
```json title="✅ STEP 2 — Define user preferences"
{
...
```http title="✅ STEP 5 — Match lists of products (batch processing)"
...
```mermaid title="✅ Final Example: Personalized Product Matching Pipeline"
flowchart TD
