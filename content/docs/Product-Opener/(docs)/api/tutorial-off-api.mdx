...
```text title="Describing the Get Request"
...
```json title="Nutri-Score Response"
{
    "code": "3017624010701",
    "product": {
        "nutrition_grades": "e",
...
```text title="Nutri-Score Computation"
...
```json title="Nutri-Score Computation"
{
    "code": "3017624010701",
    "product": {
        "nutriments": {
...
```json title="Products without a Nutri-Score"
{
    "code": "0180411000803",
    "product": {
        "misc_tags": [
...
```text title="Write data to make Nutri-Score computation possible"
...
```bash title="Write data to make Nutri-Score computation possible"
...
```json title="Write data to make Nutri-Score computation possible"
{
...
```json title="Read newly computed Nutri-Score"
{
    "code": "0180411000803",
    "product": {
        "nutriments": {
...
```text title="Describing the Search Request"
...
```json title="Describing the Search Request"
{
    "count": 1629,
    "page": 1,
    "page_count": 24,
...
```text title="Sorting Search Response"
...
```json title="Sorting Search Response"
{
    "count": 1629,
    "page": 1,
    "page_count": 24,
