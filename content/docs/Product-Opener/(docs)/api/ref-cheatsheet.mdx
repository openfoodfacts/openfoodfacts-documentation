---
title: "Reference: API CheatSheet"
---
...
```text title="Indicate the absence of nutrition facts"
...
```text title="Add nutrition facts values, units and base"
...
```text title="Adding values to a field that is already filled"
add_categories
add_labels
add_brands
```
...
```text title="Get data for a list of products"
