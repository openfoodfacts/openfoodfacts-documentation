...
<Card title="Complete Authentication Reference" href="../index#authentication">
...
<Card
  ...
  href="../tutorial-uploading-photo-to-a-product"
>
...
<Card title="Robotoff Prediction Guide" href="../intro-robotoff">
