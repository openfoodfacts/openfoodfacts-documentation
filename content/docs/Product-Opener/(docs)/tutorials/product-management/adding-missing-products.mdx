...
<Steps>
  <Step>
    **Ingredients OCR Check**: Get your users to [check ingredients OCR in an
    autonomous fashion](/docs/Product-Opener/tutorials/product-management/get-ingredient-related-analysis)
  </Step>
  <Step>
    **Nutrition Facts Input**: [Get your users to input nutrition
    facts](/docs/Product-Opener/dev/explain-nutrition-data)
  </Step>
  <Step>
    **Packaging Data**: Get your users to [input packaging
    data](/docs/Product-Opener/dev/explain-packaging-data)
  </Step>
</Steps>
