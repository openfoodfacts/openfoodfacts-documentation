...
<Steps>
  <Step>
    **Pad the barcode**: If the barcode is less than 13 digits long, it must be padded with leading 0s so that it has 13 digits.
  </Step>
  <Step>
    **Split the barcode**: Split the first 9 digits of the barcode into 3 groups of 3 digits to get the first 3 folder names, and use the rest of the barcode as the last folder name. For example, barcode `3435660768163` is split into: `343/566/076/8163`.
  </Step>
  <Step>
    **Construct the URL**: The product images will be in `https://images.openfoodfacts.org/images/products/343/566/076/8163`.
  </Step>
</Steps>
