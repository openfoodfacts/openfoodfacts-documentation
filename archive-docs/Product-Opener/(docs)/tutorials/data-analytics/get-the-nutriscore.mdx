...
description: "Complete guide to implementing Nutri-Score display in your app, handling edge cases, and ensuring proper data completion flows"
---
...
- Please refer to the [product addition tutorial](/docs/Product-Opener/tutorials/product-management/adding-missing-products) for the technical way to do the required operations (such as nutrition input), and to the high level workflow below for all the cases you have to handle.
