---
title: "Disk Extension Report"
description: "This report details the process of extending disk space on preprod and containers prod VMs on OVH2. It covers snapshoting, extending partition size, handling swap partitions, and resizing the filesystem to make the new space available."
