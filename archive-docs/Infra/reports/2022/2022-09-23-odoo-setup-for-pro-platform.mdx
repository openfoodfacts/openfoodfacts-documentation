---
title: "Odoo Setup for Pro Platform"
description: "This report details the setup of Odoo for the pro platform, focusing on API key creation, database name retrieval, and testing authentication and record creation via XML-RPC. It outlines the steps to integrate Odoo with existing systems for managing partner data."
author: "Alex Garel"
...
Following [our odoo documentation](/docs/Infra/services/odoo#contributed-modules-from-oca-store)
