---
title: "Openfoodfacts.net Unreachable"
description: "This report investigates why openfoodfacts.net became unreachable, detailing the initial problem, the underlying causes related to DNS and forwarding rules, and the steps taken to resolve the issue by reconfiguring DNS and adding a routing rule on the proxy."
author: "Charles"
mail: ""
date: "2022-08-17"
---
...
This is linked to previous problem resolution, see [Reverse proxy down on 18 fév 2022, Final resolution](/docs/Infra/reports/2022/2022-02-18-ovh-reverse-proxy-down#final-resolution).
