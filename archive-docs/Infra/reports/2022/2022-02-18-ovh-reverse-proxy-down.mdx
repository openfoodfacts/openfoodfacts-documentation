---
title: "OVH Reverse Proxy Down"
description: "This postmortem details the outage of wiki.openfoodfacts.net and other services due to a network configuration issue on the OVH reverse proxy after a reboot. It explains the root cause of incorrect default gateways and outlines the resolution, including a more robust network setup and CNAME migration."
author: "Alex"
