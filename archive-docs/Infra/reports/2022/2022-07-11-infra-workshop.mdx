...
description: "This report summarizes the infrastructure workshop held on July 11, 2022, outlining goals for horizontal scaling, improved software/hardware, human redundancy, and monitoring. It details solutions for priorities, documentation, and technology upskilling, focusing on disk space and CPU usage."
author: "Alex Garel, Charles, Christian Quest, Stephane, Pierre"
