---
title: "OFF2 PCI NVMe Problems"
description: "This report details the problems encountered with the PCI card supporting NVMe drives on off2 after an upgrade. It covers diagnosis, troubleshooting steps including BIOS configuration and physical checks, and the eventual conclusion that a faulty NVMe drive was the likely cause."
author: "Christian Quest, Alex Garel"
mail: ""
date: "2022-03-14"
---

This happens after [OFF2 upgrade](/docs/Infra/reports/2023/2023-02-17-off2-upgrade).
...
![No NVMe Drive detected on PCI](../../img/2023-03-16-off2-test-error-pci-device.png "No NVMe Drive detected on PCI while testing")
...
[Zpool error importing rpool](../../img/2023-03-16 zpool rpool error after disabling PCI.png "Zpool error importing rpool after disabling PCI")
