...
After [Christian installed first servers in november](/docs/Infra/reports/2024/2024-11-14-hetzner-server-install), we didn't go ahead with installing other servers…
It's time to do so !
