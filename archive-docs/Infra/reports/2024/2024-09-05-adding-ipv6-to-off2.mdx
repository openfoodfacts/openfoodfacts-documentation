---
title: "Adding IPv6 to Off2"
description: "This report details the process of adding IPv6 connectivity to the off2 server in the Free data center. It covers configuring public and private IPv6 addresses, setting up IP forwarding, and assigning a private IPv6 address to the stunnel-client container for communication with the Moji server."
author: "Unknown Author"
mail: ""
date: "2024-09-05"
---

As we are moving [off-query to moji](/docs/Infra/reports/2024/2024-09-04-move-off-query-to-moji)
...
See page [Free Data Center](/docs/Infra/hosting/free-datacenter#ipv6)
