---
title: "Moving OPF/OBF/OPFF Logs"
description: "This report details the process of moving logs for OPF, OBF, and OPFF services to dedicated data volumes to prevent disk space issues. It outlines the procedure for rsyncing, stopping services, moving and symlinking log directories, and restarting services to ensure continuous operation and better disk management."
