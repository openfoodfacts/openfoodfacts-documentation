---
title: "OVH Reverse Proxy IP Lost"
description: "This report details a critical incident where the OVH reverse proxy lost its IP connectivity, leading to service downtime. It covers the investigation, the process of acquiring and configuring a new IP address, and lessons learned regarding network resilience and team resource availability."
...
[^proxmox_dhcp_gateway]:
    in practice this could be done by manually changing the network configuration in the container,
...
- We could use this more:
  ...
  - We could also use additional IP for the [mail gateway](/docs/Infra/services/mail).
