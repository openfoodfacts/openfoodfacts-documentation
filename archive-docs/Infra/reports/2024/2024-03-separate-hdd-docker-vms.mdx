---
title: "Separate HDD Docker"
description: "This report details the process of separating HDD for Docker VMs, focusing on moving system data to a new disk. It covers disk space assessment, partitioning, formatting, data copying, and making the new disk bootable, including troubleshooting steps."
