---
title: "Restructure Backups"
description: "This report details the restructuring of backups, focusing on pulling off2 data from ovh3 and addressing NFS instability. It covers delegating ZFS permissions, manually syncing data, and reorganizing datasets to improve backup efficiency and stability."
...
see [Configuring snapshots and syncoid in 2023-12-08 off1 upgrade](/docs/Infra/reports/2023/2023-12-08-off1-upgrade#configuring-snapshots-and-syncoid).
...
as they are under _backups_ and inherit its _sharenfs_ property (which is needed on backups for proxmox to push files).
