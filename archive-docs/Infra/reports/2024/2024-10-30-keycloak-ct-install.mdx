---
title: "Keycloak CT Install"
description: "This report details the installation of a Keycloak container on off1 for production testing. It covers container creation, Docker setup within the container, SSH key configuration, and preparing for Keycloak deployment, including ZFS volume synchronization."
...
I will thus closely follow [2024-04 install off-query on off1](/docs/Infra/reports/2024/2024-04-12-install-off-query-off1)


## Adding overlay kernel module on off1

Was already [done for off-query](/docs/Infra/reports/2024/2024-04-12-install-off-query-off1#adding-overlay-kernel-module-on-off1)

## Creating the container

Created a container following usual steps on [creating a container](/docs/Infra/virtualization/proxmox#how-to-create-a-new-container)
...
I created a new account for John on the container following [proxmox - how to create a user in a Container or VM](/docs/Infra/virtualization/proxmox#how-to-create-a-user-in-a-container-or-vm)
