---
title: "Matomo Performance Tuning"
description: "This report details the performance tuning efforts for Matomo, focusing on optimizing archive scripts and addressing issues with queue processing. It covers PHP and MariaDB settings, redis queue management, and the implementation of multiple tracker queues."
