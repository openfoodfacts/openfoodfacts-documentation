---
title: "Move Off-Query"
description: "This report details moving off-query to the Moji server due to off1 reboots. It covers deployment, stunnel configuration for secure access, and setting up a stunnel client on off2, ensuring public and internal communication."
...
see [2024-09-05 adding ipv6 to off2](/docs/Infra/reports/2024/2024-09-05-adding-ipv6-to-off2)

### Creating stunnel-client container on off2

Created container ([see doc](/docs/Infra/virtualization/proxmox#how-to-create-a-new-container)):

- 103, stunnel-client, unpriviledge, with nesting.
- using debian 12
- disk 6G noatime, 2cores, 512Mb memory

And did usual configurations, and cloned the [off-infrastructure repository](/docs/Infra/how/how-to-have-server-config-in-git)
