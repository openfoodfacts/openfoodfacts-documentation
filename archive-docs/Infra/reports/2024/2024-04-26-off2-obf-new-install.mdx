---
title: "New OBF Install on OFF2"
description: "This report details the new installation of Open Beauty Facts (OBF) on OFF2 using updated generic Product Opener code. It covers container creation, locale setup, volume mounting, code cloning, and service configurations for Nginx and Apache, including troubleshooting and testing procedures."
---
...
The obf-new install is done by Stéphane, following closely what Alex did and documented for [opff reinstall on off2](/docs/Infra/reports/2023/2023-03-14-off2-opff-reinstall).

Refer to it if you need more explanation on a step.

## Creating Containers

I created a CT for obf-new followings [How to create a new Container](/docs/Infra/virtualization/proxmox#how-to-create-a-new-container) it went all smooth.
...
Then edit the file to change openfoodfacts.org to openbeautyfacts.org, the name of the log files etc. The result is in git.
