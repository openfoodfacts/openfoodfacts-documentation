---
title: "Move Old Product Opener Folders to Backup"
description: "This report details the process of moving old Product Opener installation folders from off1 to a backup location on off2. This action aims to free up disk space and manage storage efficiently by relocating historical data that was previously rsynced during migrations."
