---
title: "MongoDB Migration Report"
description: "This report details the 2024-01-03 MongoDB migration to a new Proxmox container on off1. It covers container creation, MongoDB installation, repository cloning, and the setup process, including challenges encountered during data migration."
...
To [upgrade off2](/docs/Infra/reports/2023/2023-02-17-off2-upgrade), we moved MongoDB to a VM kindly provided by Open Street Map France (VM codename off3) on a server located in the same datacenter.

We Then moved all the stuff from off1 to off2. We then [upgrade off1](/docs/Infra/reports/2023/2023-12-08-off1-upgrade).

It's now time to move back MongoDB instance to the upgraded off1 server. It will be installed in a container as we now use [proxmox](/docs/Infra/virtualization/proxmox)

## Creating a container

We followed usual procedure to [create a proxmox container](/docs/Infra/virtualization/proxmox#how-to-create-a-new-container):
* of id 102
...
I also [configured email](/docs/Infra/services/mail#postfix-configuration) in the container.
...
see [2024-01-04 Setting up stunnel](/docs/Infra/reports/2024/2024-01-04-setting-up-stunnel)
