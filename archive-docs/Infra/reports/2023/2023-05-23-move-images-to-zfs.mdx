---
title: Move Images to ZFS
description: This report details the migration of Open Food Facts images from normal storage to a ZFS dataset on off2, replicated on ovh3. It outlines the strategy, including reversing ZFS syncing, mounting via NFS, and using rsync for data transfer, to leverage ZFS snapshots for efficient backups.
