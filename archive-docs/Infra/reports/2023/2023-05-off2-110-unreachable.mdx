---
title: OFF2 Container Unreachable
description: This report details an issue where container 110 on OFF2 became unreachable from container 101, causing a bad gateway on OPFF. It investigates network connectivity, ARP cache problems, and provides temporary fixes, including restarting the container and resetting ARP cache, to restore communication.
