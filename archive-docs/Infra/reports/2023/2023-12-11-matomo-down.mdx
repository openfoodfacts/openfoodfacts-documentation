---
title: "Matomo Downtime Resolution"
description: "This report details the resolution of a Matomo downtime incident, covering monitoring setup, FPM-PHP and MariaDB optimization, and the implementation of Redis for performance. It also outlines the installation of Prometheus exporters for Nginx and MySQL."
...
* `dpkg-reconfigure postfix` following instructions on [how to setup email](/docs/Infra/services/mail#postfix-configuration)
