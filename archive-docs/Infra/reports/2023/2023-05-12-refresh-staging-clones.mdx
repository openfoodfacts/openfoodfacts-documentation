---
title: Refresh Staging Clones
description: This report details the process of refreshing ZFS clones for staging data, including the transition to NFS mounts, refreshing clones on ovh3, and troubleshooting issues related to NFS shares and network configuration. It also covers restarting Docker containers after clone refresh.
...
I fixed it, see [2023-04-27 moving docker staging to OVH1 / Changing route](/docs/Infra/reports/2023/2023-04-27-moving-docker-stagging-to-ovh1#changing-route)
